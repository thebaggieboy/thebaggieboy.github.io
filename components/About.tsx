  ...
  export default function About() {
    return (
      <div className="relative isolate overflow-hidden">
       ...
       I love enjoy solving complex problems by creating live functional applications. 
            I started with Python and moved on to creating dynamic websites using PHP, Javascript, and Python as my backend language.
             ...
             I am a strong candidate for any project or position requiring a fullstack web developer who can create innovative solutions, as i am very skilled in working with wide range of front and back-end technologies to produce, evaluate efficient code and applications.      </p> 
           </div>
          </div><br/>

...
<div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
  <div class="flex flex-col mb-6 lg:flex-row md:mb-10">
    <div class="lg:w-1/2">
      <h2 class="max-w-md mb-6 font-sans text-3xl tracking-tight text-teal-600  sm:text-4xl sm:leading-none xl:max-w-lg">
      What i do ?
      </h2>
  ...
  <div class="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
    <div>
      <div class="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-white">
      ...
      <h6 class="mb-2 font-semibold leading-5 text-white">Frontend Development</h6>
      ...
      <ul class="mb-4 -ml-1 space-y-2">
        <li class="flex items-start text-teal-600 text-xs ">
          <span class="mr-1">
    ...
    <div>
      ...
      <h6 class="mb-2 font-semibold leading-5 text-white">Backend Development</h6>
      <p class="mb-3 text-xs text-gray-400">
...
I also script cache controllers and load balancers to manage server traffic.
    ...
    <div>
      ...
      <h6 class="mb-2 font-semibold leading-5 text-white">Blockchain Development</h6>
      <p class="mb-3 text-xs text-gray-400">
...
I specialize in blockchain development, crafting secure and efficient decentralized applications. From smart contracts to managing nodes.
    ...
    <div>
      ...
      <h6 class="mb-2 font-semibold leading-5 text-white">Scripting</h6>
      <p class="mb-3 text-xs text-gray-400">

        ...
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-2xl py-10 sm:py-20 lg:py-20">
            ...
            <div className="text-center mx-auto p-5">
              ...
              <motion.a href="/Resume-Enimofe-Odujirin-2023.pdf" initial={{opacity:0}} animate={{opacity:1}} whileHover={{scale:1.5}} transition={{delay:0.8, duration:1.2}} className='inline-flex justify-center rounded-lg text-sm font-semibold py-3 px-4 bg-slate-900 text-white hover:bg-slate-700'>Check out my resume</motion.a>

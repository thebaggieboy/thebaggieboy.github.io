const links = [
  ...
  export default function about() {
    ...
    <div className="p-3"> <br /><br /><br />
             ...
             This helped me to grasp a strong understanding of programming as i am not limited to just the design aspects of the web(HTML, CSS, JS). I then moved to learn PHP which is a traditional and fundamental way of creating websites. After my basic knowledge in creating static websites using HTML & CSS, i scaled to creating dynamic websites using HTML & CSS with server-side code like PHP or python. 
             Now with solid understanding og backend code i improved my knowledge and efficiency by introducing my self to web frameworks like flask and django which optimised an MVC approach and helped create a solid understanding of the relation between database models, views and urls when creating a fullstack application.
